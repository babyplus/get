...
FROM registry.cn-hangzhou.aliyuncs.com/babyplus/get:a221205cf857.gcc.9_5_0 as Compiler
...
FROM registry.cn-hangzhou.aliyuncs.com/babyplus/get:a2212213c831.debian.11_6-slim
RUN apt-get update
